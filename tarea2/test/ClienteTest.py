...
def test_Falsos(): #===========================================
    ...
    try:
        ...
        clientefalso1.connect("150.150.0.2",12000)
    ...
    try:
        ...
        clientefalso2.connect("150.150.0.2",12000)
    ...
    try:
        ...
        clientefalso3.connect("150.150.0.2",12000)
    ...
    try:
        ...
        clientefalso4.connect("150.150.0.2",12000)
    ...
    try:
        ...
        clientefalso5.connect("150.150.0.2",12000)
...
def testsDemandados():
    ...
    try:
        clienteD2 = Client()
        clienteD2.connect("100.100.0.2",13000)
    ...
    try:
        clienteD4 = Client()
        clienteD4.connect("100.100.0.2",13000)
